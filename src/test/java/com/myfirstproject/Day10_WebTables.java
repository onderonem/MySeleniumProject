...
printData(2,3); => prints data in 2nd row 3rd column
    ...
    public void printTable(){
        ...
        // for loop gives elements one by one separately
        }

        // Getting 10th data from the table
        System.out.println("10th Table Data => "+tableData.get(10).getText());
        // 10th Table Data => http://www.frank.com

        //       We can assert what do we want
        //      for(WebElement w : tableData){
         //     if(!w.getText().equals("Tim")){
    ...
    public void getRows(){
        ...
        // Task 2 : Print All Rows or specific row
        driver.get("https://the-internet.herokuapp.com/tables");
        System.out.println("***Print Rows***");
        List<WebElement> allRows = driver.
                findElements(By.xpath("//table[@id='table1']//tr"));
        System.out.println(allRows.get(1).getText());  // it gives only first row

        // for (WebElement eachRow : allRows){
        // System.out.println(eachRow.getText());      // loop gives all rows one by one
        // }
    }
    ...
    public void getLastRow(){
        ...
        WebElement lastRowData = driver.
                findElement(By.xpath("//table[@id='table1']//tbody//tr[last()]"));
        System.out.println(lastRowData.getText());
        }
        // table[@id='table1']//tbody//tr//td[5]
        // We have to add tbody in the Xpath, because header has last row as well
    ...
    public void getColumn5(){
        ...
        List<WebElement> column5Data = driver.
    ...
    public void printDataTest(){
        ...
        // creating a dynamic method gives us data which
        // we want to its column and raw number and table name

        // we use here Overloading feature of Java. Same method name different parameter
