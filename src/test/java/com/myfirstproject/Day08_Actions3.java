...
public class Day08_Actions3 extends TestBase {
     ...
     * When the page is long, or element is not displayed properly
     *   b/c element is at the bottom of the page
...
//        1. To scroll pages, we can use Actions class or Javascript Executor(better)
