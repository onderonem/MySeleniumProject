...
//        (USE getText() method to get the text from the page)
        ...
        // We do not see "testtechproed@gmail.com" because idElement's data type is not string.
        // idElement is a web element, and web element's data type is hash code.
        // In order to see web element as a text, we have to use "idElement.getText()" method
...
//        Verify the Addresses are displayed
//        Addresses is a link because they have <a tag. So I can use linkText or partialLinkText
...
//        number of link = number of a tag
        ...
        // returns all elements whose tag is "a"
        // tagName("img") returns all images
...
//        Sign out from the page
         ...
         * It returns true if element is exists,
         * it returns false if element is not exist on the page
         */
    }
}