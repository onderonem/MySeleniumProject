...
//    Locate the text box
//        textBox is INSIDE an iframe. So we have to switch to that iframe
...
//    Verify the text Elemental Selenium text is displayed on the page
   ...
   /*
    ...
    I can use findElements by tag name that will return all of the
    element with iframe tags as List. Then, I use size method to find
    the number of iframe in the list.
